...
AbstractSystem::AbstractSystem(QSharedPointer<CIniFile> settings, QSharedPointer<CIniFile> proj) {
	m_projectIni = proj;
...
TokenType::Type AbstractSystem::getSystemPointerArrayType() {
...
QString AbstractSystem::CompressZX0(QString fileName) {
...
QString AbstractSystem::CompressFile(QString fileName) {
	return fileName;
}

QStringList AbstractSystem::CompressData(QStringList &inData, QString &string) {
	return QStringList();
}
