...
//    virtual void getEmulatorAndParams(QString emulator, QStringList params) = 0;
 ...
 //   virtual bool hasFixedProgramAddress() {return true;}
    ...
    enum System {C64, VIC20, PET, NES, C128, BBCM, AMIGA, PLUS4, OK64, X16,X86, GAMEBOY, SPECTRUM, TIKI100, ATARI2600, ATARI520ST, AMSTRADCPC, COLECO, MEGA65, ATARI800, MSX, APPLEII, M1ARM, ORIC, SNES, CUSTOM, VZ200, ACORN, JDH8, POKEMONMINI, TRS80, TRS80COCO, WONDERSWAN, TIM};
