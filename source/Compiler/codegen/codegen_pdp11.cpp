#include "codegen_pdp11.h"
#include "source/Compiler/ast/nodefactory.h"

CodeGenPDP11::CodeGenPDP11()
{

}


void CodeGenPDP11::dispatch(QSharedPointer<NodeBinOP>node) {
...
/*void CodeGenPDP11::dispatchOld(QSharedPointer<NodeBinOP>node)
{
    node->DispatchConstructor(as,this);
...
void CodeGenPDP11::dispatch(QSharedPointer<NodeNumber>node)
{
    as->m_varStack.push(node->getValue(as));
...
void CodeGenPDP11::dispatch(QSharedPointer<NodeString> node)
{

}

void CodeGenPDP11::dispatch(QSharedPointer<NodeUnaryOp> node)
{
  //  node->DispatchConstructor(as,this);
//    node->Accept(this);
//    if (node->isMinusOne())
...
void CodeGenPDP11::dispatch(QSharedPointer<NodeVarDecl> node)
{
...
void CodeGenPDP11::dispatch(QSharedPointer<NodeBlock> node)
{
...
void CodeGenPDP11::dispatch(QSharedPointer<NodeVarType> node)
{

}

void CodeGenPDP11::dispatch(QSharedPointer<NodeBinaryClause> node)
{
...
void CodeGenPDP11::dispatch(QSharedPointer<Node> node)
{

}

void CodeGenPDP11::dispatch(QSharedPointer<NodeRepeatUntil> node)
{
...
void CodeGenPDP11::dispatch(QSharedPointer<NodeComment> node)
{
...
void CodeGenPDP11::StoreVariable(QSharedPointer<NodeVar> n)
{
...
void CodeGenPDP11::LoadVariable(QSharedPointer<NodeVar> n)
{
...
void CodeGenPDP11::LoadVariable(QSharedPointer<NodeProcedure> node)
{
    as->Asm("lea a0,"+node->m_procedure->m_procName + " ; NOT TESTED YET");
}

QString CodeGenPDP11::LoadAddress(QSharedPointer<Node> n)
{
    n->ForceAddress();
//    qDebug() << "CodeGenPDP11::Loadaddress  "+n->getValue(as);
if (!n->isPure()) {
...
QString CodeGenPDP11::LoadAddress(QSharedPointer<Node> n, QString a0)
{
    n->ForceAddress();
    if (n->isPureNumeric() && n->isAddress()) {
//        qDebug() << "CodeGenPDP11::Loadaddress  "+n->getValue(as) << n->HexValue() << qSharedPointerDynamicCast<NodeNumber>(n)->m_val;
...
void CodeGenPDP11::LoadPointer(QSharedPointer<Node> n)
{
    QString d0 = as->m_regAcc.Get();
    //    n->Accept(m_)
...
void CodeGenPDP11::LoadVariable(QSharedPointer<Node> n)
{
...
void CodeGenPDP11::TransformVariable(QString op, QString n, QString val, QSharedPointer<Node> t)
{
...
void CodeGenPDP11::TransformVariable(QString op, QSharedPointer<NodeVar> n, QString val)
{
...
void CodeGenPDP11::TransformVariable( QString op, QString n, QSharedPointer<NodeVar> val)
{
...
void CodeGenPDP11::TransformVariable(QString op, QString n, QString val)
{
    QString flag="";
...
bool CodeGenPDP11::HandleSimpleAeqAopConst(QSharedPointer<NodeAssign> node)
{
...
bool CodeGenPDP11::HandleSimpleAeqBopConst(QSharedPointer<NodeAssign> node)
{
    QString var = node->m_left->getValue(as);
//    return false;
...
void CodeGenPDP11::CompareAndJumpIfNotEqual(QSharedPointer<Node> nodeA, QSharedPointer<Node> nodeB, QString lblJump, bool isOffPage)
{
...
void CodeGenPDP11::AssignStringPtr(QSharedPointer<NodeAssign> node, bool isPointer) {
...
void CodeGenPDP11::CompareAndJumpIfNotEqualAndIncrementCounter(QSharedPointer<Node> nodeA, QSharedPointer<Node> nodeB, QSharedPointer<Node> step, QString lblJump, bool isOffPage, bool isInclusive)
{
...
void CodeGenPDP11::AssignVariable(QSharedPointer<NodeAssign> node) {
...
void CodeGenPDP11::IncBin(QSharedPointer<NodeVarDecl> node) {
    QSharedPointer<NodeVar> v = qSharedPointerDynamicCast<NodeVar>(node->m_varNode);
    QSharedPointer<NodeVarType> t = qSharedPointerDynamicCast<NodeVarType>(node->m_typeNode);
...
void CodeGenPDP11::BuildConditional(QSharedPointer<Node> node,  QString lblSuccess, QString lblFailed, bool page)
{
...
void CodeGenPDP11::BuildToCmp(QSharedPointer<Node> node)
{
//    QString b="";
