...
void Parser::HandleVBMExportColor()
{
    ...
    img->VBMExportColor(file, param1,param2,param3);
...
//    if (m_isTRU)
  //      ErrorHandler::e.Error("TRSE Unit files cannot include other unit files")
    ...
    dirs << Util::GetSystemPrefix()+ "tutorials/tru/"+AbstractSystem::StringFromProcessor(Syntax::s.m_currentSystem->m_processor)+ QDir::separator();
