...
public:
  Compiler6502(QSharedPointer<CIniFile> ini, QSharedPointer<CIniFile> pIni)
      : Compiler(ini, pIni) {}

  void
  InitAssemblerAnddispatcher(QSharedPointer<AbstractSystem> system) override;

  void Connect() override;

  void CleanupCycleLinenumbers(QString currentFile, QHash<int, int> &ocycles,
                               QHash<int, int> &retcycles,
                               bool isCycles = true) override;
