...
void Asm68000::Program(QString name, QString vicParam)
{
...
bool Asm68000::DeclareClass(QString name, QString type, int count, QStringList data, QString pos)
{
...
*/
void Asm68000::DeclareArray(QString name, QString type, int count, QStringList data, QString pos)
{
    QString t = byte;
...
void Asm68000::DeclareVariable(QString name, QString type, QString initval, QString position)
{
    QString t = "";
    if (type.toLower()=="integer")
        t = word;
...
void Asm68000::BinOP(TokenType::Type t, bool clearFlag)
{
    QString v="";
    if (t == TokenType::PLUS)
        v = "add";
...
void Asm68000::DeclareString(QString name, QStringList initval, QStringList flags)
{
...
QString Asm68000::String(QStringList lst, bool term)
{
...
QString Asm68000::GetOrg(int pos)
{
