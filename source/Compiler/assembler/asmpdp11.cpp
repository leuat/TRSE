...
void AsmPDP11::Program(QString name, QString vicParam)
{
...
bool AsmPDP11::DeclareClass(QString name, QString type, int count, QStringList data, QString pos)
{
...
*/
void AsmPDP11::DeclareArray(QString name, QString type, int count, QStringList data, QString pos)
{
    QString t = byte;
...
void AsmPDP11::DeclareVariable(QString name, QString type, QString initval, QString position)
{
    QString t = "";
    if (type.toLower()=="integer")
        t = word;
...
void AsmPDP11::BinOP(TokenType::Type t, bool clearFlag)
{
    QString v="";
    if (t == TokenType::PLUS)
        v = "add";
...
QString AsmPDP11::String(QStringList lst, bool term)
{
...
QString AsmPDP11::GetOrg(int pos)
{
