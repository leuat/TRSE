...
//    bool m_isMulticolor = true; // OBSOLETE REWRITE
    ...
    enum Type{ NES, C64, C64_ORG, CGA1_LOW, CGA1_HIGH, CGA2_LOW, CGA2_HIGH, UNSUPPORTED, TIFF, VIC20, PICO8,OK64,X16, AMSTRADCPC, BBC, VGA, SPECTRUM, SNES, VZ200, DOS, TIM, TVC, COCO3, THOMSON, MONO, ORIC };
