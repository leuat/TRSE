...
//    m_types.append(ImageType("Hires Charmap", "vic20",LImage::Type::CharmapRegular,LColorList::Type::C64));
    ...
    m_types.append(ImageType("Oric monochrome", "ORIC",LImage::Type::ORIC, LColorList::Type::ORIC));
    m_types.append(ImageType("Oric color(experimental)", "ORIC",LImage::Type::ORIC, LColorList::Type::ORIC8));
